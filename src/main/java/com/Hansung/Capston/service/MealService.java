...
//import com.Hansung.Capston.repository.Diet.Meal.service.UserInfo.BMIService;
...
//    mealLogCreateResponse.setRecommendationCalories(bmiService.calculateBMR(user)*1.55);
